...
private static final String GET_NOAPP = "SELECT hou_noapp_id,hou_id,lan_id,hou_noapp_time,to_char(hou_noapp_date, 'yyyy-mm-dd') hou_noapp_date FROM house_noappointment where hou_id= ? and lan_id=? order by hou_noapp_id desc";
	@Override
	...
	public List<HouNoAppVO> findhoucanapp(String hou_id, String lan_id) {
		...
		try {
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(GET_NOAPP);

			pstmt.setString(1, hou_id);
			pstmt.setString(2, lan_id);
