...
public class AppointVO implements java.io.Serializable{
	...
	public String getApp_remindsee() {
		return app_remindsee;
	}
	public void setApp_remindsee(String app_remindsee) {
		this.app_remindsee = app_remindsee;
	}
