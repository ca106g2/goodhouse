...
public class AppointJNDIDAO implements AppointDAO_interface {
	...
	private static final String INSERT_STMT = "INSERT INTO appointment (appoint_id,mem_id,lan_id,hou_id,hou_app_time,hou_app_date,app_status,app_remindsee) VALUES ('APP'||LPAD(to_char(SEQ_APP_ID.nextval),7,'0'), ?, ?, ?, ?, ?, ?, ?)";
