...
<!-- =================================================================================================================== -->//submit提交失敗版，可參考form表單 action等語法
								...
								cell.html("<div class='parent'>"
	                           		 ...
	                           		 + "<div class='link'>"
	                           		 + "<form action='houNoApp2.do' method='post'><input type='hidden' name='action' value='insert'><input type='hidden' name='hou_id' value='HOU0000001'><input type='hidden' name='lan_id' value='L000000001'><input type='hidden' name='hou_noapp_time' value='H1'><input type='hidden' name='hou_noapp_date' value='"+ theDate +"'><input type='submit' value='不可預約'></form>"
