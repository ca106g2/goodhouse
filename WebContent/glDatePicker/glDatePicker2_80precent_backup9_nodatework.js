...
<!-- =================================================================================================================== -->//0317凌晨最後版，test方法form1會改變提交日期，要問大吳。
								...
								cell.html("<div class='parent'>"
	                           		 ...
	                           		 + "<div class='link'>"
	                           		 + "<form method='post' name='form1'><input type='hidden' name='action' value='insert'><input type='hidden' name='hou_id' value='HOU0000001'><input type='hidden' name='lan_id' value='L000000001'><input type='hidden' name='hou_noapp_time' value='H1'><input type='hidden' name='hou_noapp_date' value='"+ theDate +"'><input type='button' value='不可預約' onclick='test();'></form>"
