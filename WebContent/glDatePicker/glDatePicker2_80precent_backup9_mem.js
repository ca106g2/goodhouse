				...
				for(var row = 0, cellIndex = 0; row < maxRow + 1; row++) {
					for(var col = 0; col < maxCol; col++, cellIndex++) {
						...
						if(!row) {
							...
							// If not active or if not within selectableMonths, set to noday otherwise evaluate accordingly------------super important if(isSelectable ... 表示selectableDates無法選擇，if(!isSelectable ... 表示selectableDates外無法選擇-----------
							if(isSelectable ||
...
<!-- =================================================================================================================== -->//0317凌晨最後版，test方法form1會改變提交日期，要問大吳。
								var select_page  = "/CA106_G2_GoodHouse_Lin/select_page_Basic.jsp";
								...
								cell.html("<div class='parent'>"
	                           		 ...
	                           		 + "<div class='link'>"
	                           		 + "<form method='post' name='form1'><input type='hidden' name='action' value='insert'><input type='hidden' name='mem_id' value='M000000001'><input type='hidden' name='hou_id' value='HOU0000001'><input type='hidden' name='lan_id' value='L000000001'><input type='hidden' name='hou_app_time' value='A1'><input type='hidden' name='hou_app_date' value='"+ theDate +"'><input type='hidden' name='app_status' value='A0'><input type='hidden' name='app_remind' value='A0'><input type='button' value='我要預約' onclick='test();'></form>"
