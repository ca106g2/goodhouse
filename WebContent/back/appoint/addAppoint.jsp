...
<%
  AppointVO appointVO = (AppointVO) request.getAttribute("appointVO");
%>

<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>房屋不可預約新增 - addAppoint.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>預約看房行程新增 - addAppoint.jsp</h3></td><td>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="mem_id" size="45"
			 value="<%= (appointVO==null)? "M000000001" : appointVO.getMem_id()%>" /></td>
	</tr>
	
	<tr>
		<td>房東編號:</td>
		<td><input type="TEXT" name="lan_id" size="45"
			 value="<%= (appointVO==null)? "L000000001" : appointVO.getLan_id()%>" /></td>
	</tr>
	
	<tr>
		<td>房屋編號:</td>
		<td><input type="TEXT" name="hou_id" size="45"
			 value="<%= (appointVO==null)? "HOU0000001" : appointVO.getHou_id()%>" /></td>
	</tr>

	<tr>
		<td>預約時段:</td>
		<td><input type="TEXT" name="hou_app_time" size="45"
			 value="<%= (appointVO==null)? "A1" : appointVO.getHou_app_time()%>" /></td>
	</tr>
	...
	<tr>
		<td>預約狀態:</td>
		<td><input type="TEXT" name="app_status" size="45"
			 value="<%= (appointVO==null)? "A1" : appointVO.getApp_status()%>" /></td>
	</tr>
	
	<tr>
		<td>提醒看房:</td>
		<td><input type="TEXT" name="app_remind" size="45"
			 value="<%= (appointVO==null)? "A1" : appointVO.getApp_remind()%>" /></td>
	</tr>
