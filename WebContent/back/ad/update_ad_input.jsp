		...
		<td><%--${adVO.ad_id}--%></td>
			...
			<tr>
				...
				<td><input type="text" name="ad_forfree" size="45"
					value="<%=adVO.getAd_forfree()%>" /></td>
			</tr>
			<tr>
				<td>繳費狀態:</td>
				<td><select name="ad_statue">
			...
			<tr>
				<td>廣告刊登日:</td>
				<td><input type="text" name="ad_date" id="f_date"
					value="<%=adVO.getAd_date()%>"></td>
			</tr>
			<tr>
				<td>廣告狀態:</td>
			...
			<tr>
				<td></td>
				<td>
					<!-- 送積分的地方 --> <input type="hidden" name="action" value="update">
					...
					</c:forEach> <!-- END --> <input type="hidden" name="ad_id"
					value="<%=adVO.getAd_id()%>"> <input type="hidden"
					name="ad_sort_id" value="<%=adVO.getAd_sort_id()%>"> <input
					type="hidden" name="lan_id" value="<%=adVO.getLan_id()%>">
					<input type="hidden" name="hou_id" value="<%=adVO.getHou_id()%>">
					<input type="hidden" name="requestURL"
					value="<%=request.getServletPath()%>"> <input type="hidden"
					name="whichPage" value="<%=request.getParameter("whichPage")%>">
