				...
				<div class="card">
					...
					<div class="card-body">
						<div class="table-responsive">
							<form name="the_form" method="post" action="contract.do" class="text-center">
								<table
...
<!-- 												<textarea name="con_content" value="" class="btn btn-light" rows="5" cols="150" placeholder="輸入其他特別協議"></textarea> -->
								...
								<input type="submit" value="送出修改" class="btn btn-outline-info" style="margin-top:15px">
							</form>
						</div>
			...
			<textarea name="con_content" value="" class="btn btn-light text-left" rows="50" cols="180" placeholder="" id="conContent">
								                           	   房   屋   租   賃   契   約   書
