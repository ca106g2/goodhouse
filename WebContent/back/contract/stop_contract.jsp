		...
		<div class="row justify-content-center">
					...
					<div class="card-body">
						<div class="table-responsive">
							<form name="the_form" method="post" action="contract.do"
								...
								<input type="hidden" name="con_content" id="conContent" value="${conVO.con_content}"> 
								<input type="submit" value="送出修改" class="btn btn-outline-info h3"
									style="font-weight: bold; margin-top: 15px; font-size: 20px">
							</form>
						</div>
					</div>
				</div>
			...
			<div class="justify-content-center" style="margin-top: 15px">
				<div class="card" style="background-color: #E8F8F5">
					<div class="card-body" style="background-color:#E8F8F5">
