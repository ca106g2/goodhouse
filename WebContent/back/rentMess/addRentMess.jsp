...
<%
  RentMessVO rentMessVO = (RentMessVO) request.getAttribute("rentMessVO");
%>
...
<table id="table-1">
	<tr><td>
		 <h3>租屋訊息新增 - addRentMess.jsp</h3></td><td>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="hou_id" size="45"
			 value="<%= (rentMessVO==null)? "HOU0000001" : rentMessVO.getHou_id()%>" /></td>
	</tr>
	<tr>
		<td>會員編號:</td>
		<td><input type="TEXT" name="mem_id" size="45"
			 value="<%= (rentMessVO==null)? "M000000001" : rentMessVO.getMem_id()%>" /></td>
	</tr>

	<tr>
		<td>房東編號:</td>
		<td><input type="TEXT" name="lan_id" size="45"
			 value="<%= (rentMessVO==null)? "L000000001" : rentMessVO.getLan_id()%>" /></td>
	</tr>
	...
	<tr>
		<td>提問內容:</td>
		<td><input type="TEXT" name="ren_mes_request" size="45"
			 value="<%= (rentMessVO==null)? "安安你好" : rentMessVO.getRen_mes_request()%>" /></td>
	</tr>
	
	<tr>
		<td>回覆內容:</td>
		<td><input type="TEXT" name="ren_mes_response" size="45"
			 value="<%= (rentMessVO==null)? "安安你好" : rentMessVO.getRen_mes_response()%>" /></td>
	</tr>
...
<% 
  ...
  try {
	    ren_mes_time = rentMessVO.getRen_mes_time();
   } catch (Exception e) {
...
<script>
        ...
        $('#f_date1').datetimepicker({
		   ...
		   value: '<%=ren_mes_time%>', // value:   new Date(),
